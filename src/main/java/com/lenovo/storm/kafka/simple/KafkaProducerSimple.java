package com.lenovo.storm.kafka.simple;
...
public class KafkaProducerSimple {
    public static void main(String[] args) {
         ...
         */
        props.put("partitioner.class", "com.lenovo.storm.kafka.simple.MyLogPartitioner");
...
*/
             ...
             */
            producer.send(new KeyedMessage<String, String>(TOPIC, messageNo + "", "appid" + UUID.randomUUID() + "lenovo"));
        }
    }
}
